...
import numpy as np
import os
from hire import preprocess_hire_data, get_sensitive_directions_and_projection_matrix, get_consistency, get_metrics
from train_clp_hire import train_fair_nn
...
def main(out_folder = './metrics/'):
    ...
    relevant_val = [gender_consistency, acc_temp, bal_acc_temp, gender_gap_rms_temp, gender_max_gap_temp]
